...
Revision ID: 3ce20e62503d
Revises: 
Create Date: 2019-05-08 09:24:44.116691
...
def upgrade():
    ...
    sa.Column('studySpace_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['studySpace_id'], ['study_space.id'], ),
